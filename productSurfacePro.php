...
<body>
  ...
  <div class="product-display">
    <div class="product-image-display">
      <a
        href="https://www.jbhifi.com.au/products/microsoft-surface-pro-11th-edition-copilot-pc-13-snapdragon-x-plus-16gb-256gb-platinum"
        alt="">
        <img src="./images/product/MicrosoftSurfacePro.png" alt="" />
      </a>
    </div>
    <aside class="product-detail">
      <div class="product-desc">
        <ul>
          <li id="name">
            <h1>
              Microsoft Surface Pro (11th Edition) Copilot+ PC 13" Snapdragon
              X Plus/16GB/256GB
            </h1>
          </li>
          <li id="rating">&starf;&starf;&starf;&starf;&star;</li>
          <li id="prices">$1899</li>
        </ul>
        <hr />
        <p id="desc">
